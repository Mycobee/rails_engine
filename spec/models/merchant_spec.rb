...
RSpec.describe Merchant, type: :model do
	 before :each do 
		...
		@failed_transaction_1a = create(:transaction, invoice: @invoice_1a, created_at: 1.day.ago)
		...
		@failed_transaction_2a = create(:transaction, invoice: @invoice_2a, created_at: 2.day.ago)
		...
		@failed_transaction_2b = create(:transaction, invoice: @invoice_2b, created_at: 2.day.ago)
		...
		@failed_transaction_3a = create(:transaction, invoice: @invoice_3a, created_at: 3.days.ago)
		...
		@failed_transaction_3b = create(:transaction, invoice: @invoice_3b, created_at: 3.days.ago)
		...
		@failed_transaction_3c = create(:transaction, invoice: @invoice_3c, created_at: 3.days.ago)
		...
		@failed_transaction_4a = create(:transaction, invoice: @invoice_4a, created_at: 4.days.ago)
		...
		@failed_transaction_4b = create(:transaction, invoice: @invoice_4b, created_at: 4.days.ago)
		...
		@failed_transaction_4c = create(:transaction, invoice: @invoice_4c, created_at: 4.days.ago)
		...
		@failed_transaction_4d = create(:transaction, invoice: @invoice_4d, created_at: 4.days.ago)
	end
