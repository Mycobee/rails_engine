...
RSpec.describe Merchant, type: :model do
	 before :each do 
		...
		@failed_transaction_1a = create(:transaction, invoice: @invoice_1a)
		...
		@failed_transaction_2a = create(:transaction, invoice: @invoice_2a)
		...
		@transaction_2b = create(:transaction, invoice: @invoice_2b)
		@failed_transaction_2b = create(:transaction, invoice: @invoice_2b)
		...
		@transaction_3a = create(:transaction, invoice: @invoice_3a)
		@failed_transaction_3a = create(:transaction, invoice: @invoice_3a)
		...
		@transaction_3b = create(:transaction, invoice: @invoice_3b)
		@failed_transaction_3b = create(:transaction, invoice: @invoice_3b)
		...
		@transaction_3c = create(:transaction, invoice: @invoice_3c)
		@failed_transaction_3c = create(:transaction, invoice: @invoice_3c)
		...
		@transaction_4a = create(:transaction, invoice: @invoice_4a)
		@failed_transaction_4a = create(:transaction, invoice: @invoice_4a)
		...
		@transaction_4b = create(:transaction, invoice: @invoice_4b)
		@failed_transaction_4b = create(:transaction, invoice: @invoice_4b)
		...
		@transaction_4c = create(:transaction, invoice: @invoice_4c)
		@failed_transaction_4c = create(:transaction, invoice: @invoice_4c)
		...
		@transaction_4d = create(:transaction, invoice: @invoice_4d)
		@failed_transaction_4d = create(:transaction, invoice: @invoice_4d)
	end
